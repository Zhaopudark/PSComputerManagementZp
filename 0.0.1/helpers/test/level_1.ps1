...
# Write-Output "In level1, local_var is $local_var"
# Write-Output "In level1, script_var is $script_var"
# Write-Output "In level1, global_var is $global_var"