$var += "222"
Write-Output "In level2, var is $var"
$local:local_var += "222"
Write-Output "In level2, local_var is $local_var"
$global:script_var += "222"
Write-Output "In level2, script_var is $script_var"
$global:global_var += "222"
Write-Output "In level2, global_var is $global_var"
